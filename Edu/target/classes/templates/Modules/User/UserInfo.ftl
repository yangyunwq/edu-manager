        ...
        <div class="edit">
            ...
            <ul>
                <li><input type="button" value="新增" class="addition"
                           data-url="${request.contextPath}/user/userEdit"
            ...
            <table cellpadding="0" cellspacing="0"
                ...
                <tbody>
                    ...
                    <tr onclick="Common.switchLine(this,event);">
                        <td style="width: 80px; text-align: center;"><p><span>${user1.username?default("")}</span></p></td>
                        <td style="width: 100px; text-align: center;"><p><span>${user1.email?default("")}</span></p></td>
                        <td style="width: 80px; text-align: center;"><p><span>${user1.qq?default("")}</span></p></td>
                        <td style="width: 80px; text-align: center;"><p><span>${user1.tel?default("")}</span></p></td>
                        <td style="width: 100px; text-align: center;"><p><span>${user1.alipay?default("")}</span></p></td>
                        <td style="width: 80px; text-align: center;"><p><span>${user1.name?default("")}</span></p></td>
                        <td style="width: 80px; text-align: center;"><p><span>${user1.amount?default("")}</span></p></td>
                        <td style="width: 80px; text-align: center;"><p><span>${user1.balance?default("")}</span></p></td>
                        <td style="width: 80px; text-align: center;"><p><span>${user1.register?default("")}</span></p></td>
